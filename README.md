This is a Telegram Bot written in Python for mirroring files on the Internet, and you can upload them to your Google Drive, Telegram, rclone drive or direct storage. Based on [anasty17:mirror-leech-telegram-bot](https://github.com/lzzy12/python-aria-mirror-bot)
...
- Clone status
- ~~Search in multiple Drive folder/TeamDrive~~ (This function will be optimized or deleted later.)
...
sudo docker run -d \
  --name=msbot \
  -v /home/docker/msbot/download:/usr/src/app/storage \
  -v /home/docker/msbot/config:/usr/src/app/config \
  -p 11000:11000 \
  --restart on-failure \
  mas-tgbot:latest
```
