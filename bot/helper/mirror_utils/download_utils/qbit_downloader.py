...
from bot import download_dict, download_dict_lock, BASE_URL, get_client, WEB_PINCODE, TORRENT_TIMEOUT, LOGGER
    ...
    def __qb_listener(self):
        try:
            ...
            if tor_info.state == "metaDL":
                ...
                self.__stalled_time = time()
                # if not self.__dupChecked and STOP_DUPLICATE and ospath.isdir(f'{self.__path}') and self.__listener.uptype == 'gdrive' and not self.select:
